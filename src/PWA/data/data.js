...
export const POAData = [
  {
    title: "Registration of a POA",
    text: "The POA can de certified online or issued at the Dubai Court",
  },
  {
    title: "Notarization of copies",
    text: "Authenticate copies of your personal documents.",
  },
  {
    title: "Certification of a POA",
...
export const employmentData = [
  {
    ...
    text: "Draft employment contracts, confidentiality agreements, and non-compete agreements.",
  },
  {
    title: "Diploma Legalization",
    text: "Authenticate diplomas at UAE Ministry of Foreign Affairs for professional registration.",
  },
  {
    title: "Government agency document submission",
    text: "Document submissions to government agencies (labor department, immigration service, ets).",
  },
  {
    title: "Visa Assistance",
    text: "Address visa issues with the immigration authorities",
  },
  {
    title: "Medical testing support",
    text: "Provide support throughout the process of medical examinations and biometric testing.",
  },
  {
    title: "Visa issuance",
    text: "Facilitating issuance of visas and Emirates ID cards for individuals in the UAE",
  },
  {
    title: "Employment advisory",
    text: "Provide guidance on employee registration, payroll, termination, and severance pay.",
  },
];
...
export const TMRegistrationData = [
  {
    stage: "1st stage",
...
export const investorVisaData = [
  { isHighlighted: false, name: "Validity", term: "2", termFrame: "years" },
  { isHighlighted: false, name: "Terms", term: "4", termFrame: "working days" },
  { isHighlighted: true, name: "Price", term: "AED", termFrame: "7,000" },
];

export const investorVisaRequirements = [
  "21+ years",
  "Personal photo",
  "Passport",
  "Company registration or license",
];

export const investorVisaPros = [
  { title: "Family sponsorship" },
  { title: "Annuel UAE visit requirement" },
  { title: "Opening local bank account" },
  { title: "Opportunity to obtain a credit card" },
  { title: "Opportunity to establish a corporate bank account" },
  { title: "Opportunity to sign a rental agreement" },
  { title: "Purchase long-term mobile number" },
];

export const goldenVisaPros = [
  { title: "Family sponsorship" },
  { title: "Annuel UAE visit requirement" },
  { title: "Opening local bank account" },
  { title: "Tax Exemption" },
...
export const GoldenVisaData = [
  { isChecked: false, name: "Validity", term: "10", termFrame: "years" },
  { isChecked: false, name: "Terms", term: "8", termFrame: "working days" },
  { isChecked: true, name: "Price", term: "AED", termFrame: "15,000" },
];

export const GoldenVisaRequirements = [
  "21+ years",
  "Property price 2M+ AED",
  "Min 30% construction completion requirement",
];
